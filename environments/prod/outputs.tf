...
output "accounts_plan_role_arn" {
  description = "Set as AWS_ACCOUNTS_PLAN_ROLE_ARN_PROD in terraform-accounts Repository Secrets"
  value       = aws_iam_role.accounts_plan.arn
}

output "accounts_apply_role_arn" {
  description = "Set as AWS_ACCOUNTS_ROLE_ARN in terraform-accounts GitHub Environment prod"
